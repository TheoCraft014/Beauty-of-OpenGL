    ...
    class Camera
    {
     public:
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 localRight = glm::vec3(right.x, 0, right.z);
            position += glm::normalize(localRight) * distance;
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newForward = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 0);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newForward = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(newForward));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newRight = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 0);
